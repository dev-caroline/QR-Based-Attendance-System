...
// Helper function to generate time-based token (changes every 30 seconds)
...
// Helper function to get current time window (30-second intervals)
const getCurrentTimeWindow = () => {
    return Math.floor(Date.now() / 30000);
};

// Helper function to validate token (accepts current and previous window for 30-second grace period)
